...
for schema_path in (
    ...
    defs = schema["$defs"]
    defs["defectArtifactReference"] = {
        "type": "object",
        "additionalProperties": False,
        "required": ["artifact_id", "relation", "artifact_redacted"],
        "properties": {
            "artifact_id": {"type": "string", "minLength": 1},
            "relation": {"type": "string", "minLength": 1},
            "artifact_redacted": {"type": "boolean"},
        },
    }
    defect = defs["defect"]
    if "artifact_refs" not in defect["required"]:
        defect["required"].append("artifact_refs")
    defect["properties"]["artifact_refs"] = {
        "type": "array",
        "items": {"$ref": "#/$defs/defectArtifactReference"},
    }
