    ...
    def run(
        ...
        *,
        ...
        if check and completed.returncode != 0:
            detail = completed.stderr.strip() or completed.stdout.strip() or "unknown GitHub CLI failure"
            ...
            raise GitHubCLIError(f"GitHub CLI command failed ({completed.returncode}): {detail}")
        return result
